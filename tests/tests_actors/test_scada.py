...
def test_scada_small():
    ...
    # TODO: ADD back when fsm events are in place
...
# TODO: add test back when fsm-based atn commands exist
# @pytest.mark.asyncio
...
# TODO: add back after fsm dynamics are implemented
# @pytest.mark.asyncio
