...
>
    ...
    <xsl:template match="/*">
        <FileSet>
            <FileSetFiles>
                <xsl:for-each select="//GwEntities/GwEntity[normalize-space(AllObjectsStatic) = 'true']">
                ...
                <FileSetFile>
                    <RelativePath>
                        <xsl:text>../../../data_classes/</xsl:text><xsl:value-of select="PythonName"/><xsl:text>_static.py</xsl:text>
                    </RelativePath>
