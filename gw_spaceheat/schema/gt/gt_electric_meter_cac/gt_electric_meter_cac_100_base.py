...
class GtElectricMeterCac100Base(NamedTuple):
    ComponentAttributeClassId: str     #
    MakeModel: MakeModel     #
    CommsMethod: Optional[str] = None
    DisplayName: Optional[str] = None
    Alias: str = 'gt.electric.meter.cac.100'
    ...
    def derived_errors(self) -> List[str]:
        ...
        if self.Alias != 'gt.electric.meter.cac.100':
            errors.append(f"Type requires Alias of gt.electric.meter.cac.100, not {self.Alias}.")
