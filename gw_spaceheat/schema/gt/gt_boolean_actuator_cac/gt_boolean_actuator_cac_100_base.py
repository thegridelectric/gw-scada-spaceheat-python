...
class GtBooleanActuatorCac100Base(NamedTuple):
    ComponentAttributeClassId: str     #
    MakeModel: MakeModel     #
    DisplayName: Optional[str] = None
    Alias: str = 'gt.boolean.actuator.cac.100'
    ...
    def derived_errors(self) -> List[str]:
        ...
        if self.Alias != 'gt.boolean.actuator.cac.100':
            errors.append(f"Type requires Alias of gt.boolean.actuator.cac.100, not {self.Alias}.")
