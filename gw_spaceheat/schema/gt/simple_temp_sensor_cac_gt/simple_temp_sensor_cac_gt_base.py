"""Base for simple.temp.sensor.cac.gt.000"""
import json
...
class SimpleTempSensorCacGtBase(NamedTuple):
    ...
    TypeAlias: str = "simple.temp.sensor.cac.gt.000"
    ...
    def derived_errors(self) -> List[str]:
        ...
        if self.TypeAlias != "simple.temp.sensor.cac.gt.000":
            errors.append(
                f"Type requires TypeAlias of simple.temp.sensor.cac.gt.000, not {self.TypeAlias}."
            )
