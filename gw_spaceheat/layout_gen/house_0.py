...
from data_classes.house_0_layout import House0Names, House0StartHandles
...
class House0ChStubs:
    ...
    def __init__(self, total_store_tanks: int, zone_list: List[str]):
        NAMES = House0Names(total_store_tanks, zone_list)
...
class House0LayoutDb(LayoutDb):
    ...
    def __init__(
        ...
        self.names = House0Names(total_store_tanks, zone_list)
            ...
            [
                SpaceheatNodeGt(
                    ShNodeId=self.make_node_id(
                        f"s.{self.names.REV_GRADE_POWER_METER}"
                    ),
                    Name=self.names.REV_GRADE_POWER_METER,
