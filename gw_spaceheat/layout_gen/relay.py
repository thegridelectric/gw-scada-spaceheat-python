...
def add_relays(
    ...
    if not db.component_id_by_alias(component_display_name):
        config_list = [
            ...
            RelayActorConfig(
                ...
                DeEnergizedState=HpLoopKeepSend.KeepLess,
                EnergizedState=HpLoopKeepSend.KeepMore,
                AsyncCapture=True,
                Exponent=0,
                Unit=Unit.Unitless,
            ),
    ...
    node_list = [
        ...
        SpaceheatNodeGt(
            ...
            Handle=f"auto.{H0N.home_alone}.{H0N.home_alone_normal}.{H0N.hp_boss}.{H0N.hp_scada_ops_relay}",
            ActorClass=ActorClass.Relay,
        ...
        SpaceheatNodeGt(
            ...
            Handle=f"auto.{H0N.home_alone}.{H0N.home_alone_normal}.{H0N.sieg_loop}.{H0N.hp_loop_on_off}",
            ActorClass=ActorClass.Relay,
        ...
        SpaceheatNodeGt(
            ...
            Handle=f"auto.{H0N.home_alone}.{H0N.home_alone_normal}.{H0N.sieg_loop}.{H0N.hp_loop_keep_send}",
            ActorClass=ActorClass.Relay,
            DisplayName="Hp Loop Valve KeepMore/KeepLess Relay",
            ComponentId=db.component_id_by_alias(component_display_name),
        ),
    ]
