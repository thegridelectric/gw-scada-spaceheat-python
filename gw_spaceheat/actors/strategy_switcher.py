from actors.primary_scada.primary_scada import Primary_Scada
...
def main(python_actor_name):
    switcher = {}
    switcher['PrimaryScada'] = Primary_Scada
    switcher['PipeFlowMeter'] = Pipe_Flow_Meter
    switcher['PowerMeter'] = Power_Meter
    switcher['Atn'] = Atn
    func = switcher.get(python_actor_name, lambda x: f"No python implementation for strategy {python_actor_name}")
