"""FlowTotalizer implementation.

The FlowTotalizer delegates most of its work to a FlowTotalizerDriverThread. FlowTotalizerDriverThread in turn delegates
its threading infrastructure to SyncAsyncInteractionThread. FlowTotalizers provides FlowTotalizerDriverThread with an
...
class FlowTotalizerDriverThread(SyncAsyncInteractionThread):
...
class FlowTotalizer(SyncThreadActor):
    ...
    def __init__(
        ...
        if driver_thread is None:
            if driver_thread_class is None:
                driver_thread_class = FlowTotalizerDriverThread
