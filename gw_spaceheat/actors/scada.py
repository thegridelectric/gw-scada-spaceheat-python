...
class Scada(ScadaInterface, Proactor):
    ...
    def remaining_elec_received(self, from_node: ShNode, payload: RemainingElec) -> None:
    ...
    def scada_params_received(self, from_node: ShNode, payload: ScadaParams, testing: bool = False) -> None:
        ...
        if payload.FromGNodeAlias != self.hardware_layout.atn_g_node_alias:
            self.log(f"ScadaParams from {payload.FromGNodeAlias}; expect {self.hardware_layout.atn_g_node_alias}!")
            return
